...
part '../widgets/_input_query.dart';
...
class LoginAlumniPage extends StatelessWidget {
  const LoginAlumniPage({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocProvider<LoginAlumniCubit>(
      create: (context) => LoginAlumniCubit(),
      child: const LoginAlumniView(),
    );
  }
}

class LoginAlumniView extends StatelessWidget {
  const LoginAlumniView({super.key});
